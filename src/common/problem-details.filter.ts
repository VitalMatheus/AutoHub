...
const SAFE_CODE_DETAILS: Record<string, string> = {
  ...
  DATA_RETENTION_EXPIRED: 'O prazo de retenção dos dados terminou; o acesso da conta foi encerrado.',
...
export class ProblemDetailsFilter implements ExceptionFilter {
  ...
  private problemType(code: unknown, status: number): string {
    ...
    if (code === 'DATA_RETENTION_EXPIRED') return 'https://api.autohub.local/problems/data-retention-expired';
