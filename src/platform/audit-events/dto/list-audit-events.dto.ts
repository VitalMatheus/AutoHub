...
export enum AuditAction {
  ...
  SUBSCRIPTION_CREATED = 'subscription.created', SUBSCRIPTION_MIGRATED_REGULARIZED = 'subscription.migrated_regularized', SUBSCRIPTION_PLAN_CHANGE_SCHEDULED = 'subscription.plan_change_scheduled', SUBSCRIPTION_RECURRING_ADJUSTMENT_SCHEDULED = 'subscription.recurring_adjustment_scheduled', SUBSCRIPTION_PLAN_CHANGE_APPLIED = 'subscription.plan_change_applied', SUBSCRIPTION_RECURRING_ADJUSTMENT_APPLIED = 'subscription.recurring_adjustment_applied', SUBSCRIPTION_CANCELLATION_CONFIRMATION_REQUESTED = 'subscription.cancellation_confirmation_requested', SUBSCRIPTION_CANCELLATION_CONFIRMED = 'subscription.cancellation_confirmed', SUBSCRIPTION_CANCELLATION_REQUESTED = 'subscription.cancellation_requested', SUBSCRIPTION_CANCELLATION_UNDONE = 'subscription.cancellation_undone', SUBSCRIPTION_CANCELLED = 'subscription.cancelled', SUBSCRIPTION_DATA_FINALIZED = 'subscription.data_finalized', SUBSCRIPTION_TRIAL_EXCEPTION_GRANTED = 'subscription.trial_exception_granted',
