...
export type WorkOrderStockOption = { id: string; productId: string; availableQuantity: number; unitCost: string | null; purchaseDate: string; supplier: { id: string; name: string } | null; purchase: { id: string; documentNumber: string | null } | null; batchNumber: string | null; warrantyDays: number };
export type WorkOrder = { id: string; number: number; customerId: string; vehicleId: string; customer?: { name: string }; vehicle?: { plate: string; brand: string; model: string }; quoteId: string | null; status: WorkOrderStatus; reportedProblem: string | null; diagnosis: string | null; mileage: number | null; expectedCompletionDate: string | null; notes: string | null; items: DocumentItem[]; stockOptions?: WorkOrderStockOption[]; stockAllocations?: { id: string; workOrderItemId: string; stockEntryId: string | null; quantity: number; unitCost: string | null; stockEntry?: { supplier?: { name: string }; purchase?: { id: string; documentNumber: string | null }; warrantyDays: number; purchaseDate: string } }[]; total: string; createdAt: string; updatedAt: string };
