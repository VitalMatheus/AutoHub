...
export type Quote = { id: string; number: number; customerId: string; vehicleId: string; status: QuoteStatus; notes: string | null; items: DocumentItem[]; total: string; createdAt: string; updatedAt: string };
