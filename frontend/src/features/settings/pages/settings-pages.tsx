...
export function SettingsPage() {
  ...
  const invite = useMutation({ mutationFn: inviteOrganizationUser, onSuccess: (result) => { setFeedback({ kind: 'success', message: `Convite criado para ${result.user.email}. Token de ativação (exiba apenas uma vez): ${result.activationToken}` }); void client.invalidateQueries({ queryKey: ['organization-users'] }).catch(() => undefined); } });
